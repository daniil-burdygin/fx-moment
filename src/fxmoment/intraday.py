...
def write_intraday_report(
    ...
    lines += [
        ...
        "",
        "Месяц в днях (h = 20) против месяца в барах (h = 180) по окнам, начинающимся не раньше "
        "первого внутридневного окна коридора. Сравнение честно по периоду и горизонту, но не по "
        "числу наблюдений: на часовой оси шагов в девять раз больше.",
        "",
