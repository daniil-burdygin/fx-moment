...
def write_intraday_report(
    ...
    lines += [
        ...
        "",
        "Ниже — точность потока по сценариям. `windows` здесь считает окна, в которых сценарий "
        "срабатывал, а не все окна коридора, поэтому у редкого сценария медиана частоты выходит выше "
        "частоты коридора из таблицы выше, где молчащие окна учтены нулями.",
        "",
