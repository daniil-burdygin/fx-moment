...
|---|---|---|---|
| Презентация проекта | `.pdf`, `.pptx`, до 2 файлов | `1_Презентация_проекта/` | **к загрузке — `Презентация_финальная_v5.pdf`** (31 страница, сборка ночи 07.09: титул → 0a, 0b → 16 страниц прототипа → девять содержательных → цена ожидания → пилот → что не сработало → финал → команда; числа сверены с репозиторием, исходники правок — `Слайды_исходники/`); `Презентация_финальная.pdf` — v4 напарников, нетронутая, для сравнения. Печать PDF из HTML — командой из README промежуточных артефактов |
