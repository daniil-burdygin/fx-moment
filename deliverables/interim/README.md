...
|---|---|---|
| Описание проекта (Markdown, обязательно) | `Описание_проекта_промежуточное.md` | готово: числа сверены с `reports/`, `prosaic check` чист |
...
| Дополнительные материалы | ссылка на репозиторий, `../../reports/latest/README.md`, `../../reports/latest/analysis/README.md`, `../../reports/intraday/README.md`, графики `chart_*.png`, `frontier.png`, `cbr_vs_moex_by_hour.png` | готовы |
