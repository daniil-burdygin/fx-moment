...
|---|---|---|
| Описание проекта (Markdown, обязательно) | `Описание_проекта_промежуточное.md` | обновлено 04.09: вечерние результаты 03.09 (календарь как база, выживаемость, сожаление, вариантные прогоны) и раздел «Команда»; копия в `../промежуточные_артефакты/2_Описание_проекта/` |
...
| Презентация (обязательно) | `../промежуточные_артефакты/1_Презентация_проекта/Презентация_промежуточная.pdf` (HTML-исходник рядом) | готово 04.09: 15 слайдов, числа с коммита `7280800` |
