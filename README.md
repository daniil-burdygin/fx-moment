...
- **Часовые пояса.** ЦБ публикует курс в 16:00 МСК на завтра, пуш ждёт местного окна клиента (пояса от МСК−1 до МСК+9) и перед отправкой сверяется с курсом приложения. Вечерний гейт и его цена — `analysis/evening_gate.csv`.
